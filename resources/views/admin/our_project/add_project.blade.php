                        ...
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Fabricator Project Add Form</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('project.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea  name="short_des" autocomplete="off" class="form-control @error('short_des') is-invalid @enderror"></textarea>
                                @error('short_des')
                                    <span class="text-danger"> {{$message}}  </span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea  name="short_des_jp" autocomplete="off" class="form-control @error('short_des_jp') is-invalid @enderror"></textarea>
                                @error('short_des_jp')
                                    <span class="text-danger"> {{$message}}  </span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea  name="detail_des" autocomplete="off" class="form-control @error('detail_des') is-invalid @enderror" style="min-height: 120px"></textarea>
                                @error('detail_des')
                                    <span class="text-danger"> {{$message}}  </span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea  name="detail_des_jp" autocomplete="off" class="form-control @error('detail_des_jp') is-invalid @enderror" style="min-height: 120px"></textarea>
                                @error('detail_des_jp')
                                    <span class="text-danger"> {{$message}}  </span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                onchange="loadFile(event)">
                                    <img src="{{asset('fontend/images/project-image-size.jpg')}}" id="output" style="width: 300px;height:auto;margin-top:10px;border: 1px solid #ccc;">
                            </div>
                        </div>
