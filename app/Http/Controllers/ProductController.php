...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Image::make($product_thambnail)->resize(600,450)->save('uploads/images/product/thambnail/'.$product_thambnail_name_gen);
    ...
    public function change_thumbnail(Request $request,$id)
    {
        ...
        if(is_file($new_product_thambnail))
        {
            ...
            Image::make($new_product_thambnail)->resize(600,450)->save('uploads/images/product/thambnail/'.$image_name_gen);
        ...
        if($productimage)
        {
            foreach($productimage as $pimage)
            {
                if($pimage->getClientOriginalExtension()=='png'||$pimage->getClientOriginalExtension()=='jpg'||$pimage->getClientOriginalExtension()=='jpeg')
                {
                    ...
                    Image::make($pimage)->resize(600,450)->save('uploads/images/product/multipleimage/'.$name_gen);
    ...
    public function update_productimage(Request $request,$id)
    {
        ...
        if($productimage)
        {
                ...
                Image::make($productimage)->resize(600,450)->save('uploads/images/product/multipleimage/'.$name_gen);
